...
import siteInfoSlice from "./slice/siteInfoSlice";
...
const persistedReducer = persistReducer(persistConfig, siteInfoSlice);

// Configure the store with persistedReducer
export const store = configureStore({
  reducer: {
    siteInfo: persistedReducer, // Use persisted reducer for userInfo
  },
